...
} from "firebase/auth"; // importar funciones de autenticacion de firebase

const auth = getAuth(app); // inicializamos la autenticacion.

export default function Login() {
  const [registro, setRegistro] = useState(false); // estado para cambiar el texto del boton

  const handlerSumit = async (e) => {
    // funcion para crear un usuario o Iniciar Sesion
    e.preventDefault();
        ...
        <div className="container mt-5">
          ...
          <form className="mt-4" onSubmit={handlerSumit}>
            ...
            <button
              ...
              className={
                registro
                  ? "btn btn-success mt-4 form-control"
                  : "btn btn-primary mt-4 form-control"
              }
            >
