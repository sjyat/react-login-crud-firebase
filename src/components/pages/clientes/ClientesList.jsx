...
export default function ClientesList() {
  ...
  const deleteApi = async (id) => {
    const userDoc = doc(db, "clientes", id); // referencia al documento de firebase que queremos eliminar ej: doc(db, "users", id)
  ...
  const editData = (id, name, phone, company) => {
    const data = {
  ...
  return (
    <>
      <div>
        ...
        >
          <Box sx={style}>
            <AddClientes closeEvent={handleClose} />
          </Box>
        </Modal>
        ...
        >
          <Box sx={style}>
            <EditClientes closeEvent={handleEditClose} fid={formid} />
          </Box>
        </Modal>
      </div>
